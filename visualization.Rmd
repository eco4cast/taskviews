...
```{r pairs, fig.cap = "Combined scatterplot matrix and correlation matrix for five weather variables from the noaa GEFS model at the Oak Ridge National Lab NEON site."}
...
```{r barplot, fig.cap="Barplot showing the mean density of *Aamblyomma americanum* larvae observed in June 2019 at 5 NEON sites"}
tick_targets %>%
