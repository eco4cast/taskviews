...
* Tools for creating colorblind friendly graphics include: 
  ...
  + [Viridis](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html)is an R package that provide a series of color maps that are designed to improve graph readability for readers with common forms of color blindness and/or color vision deficiency
  ...
  + [Colorspace](https://cran.r-project.org/web/packages/colorspace/vignettes/colorspace.html) is an R package provides a broad toolbox for selecting individual colors or color palettes, manipulating these colors, and employing them in various kinds of visualizations
...
#### Other Resources or Uncertainty Visualization
...
* Weissgerber, Tracey L., et al. "Beyond bar and line graphs: time for a new data presentation paradigm." PLoS biology 13.4 (2015): e1002128. [https://doi.org/10.1371/journal.pbio.1002128](https://doi.org/10.1371/journal.pbio.1002128)
